...
void loop()
{
  ...
  if (latest.getEvent() != "Default") {
    ...
    /*if (strcmp(latest.getParent(), "Button_1") == 0) {
      //mgui_set_value("Textfield_1", 5);

      mgui_set_text("Textfield_1", "Hello");
    }*/
    if (latest.getEvent() == "test") {
      mgui_set_text("Textfield_1", "Hola ninja");
      //mgui_set_value("Textfield_1", 52);
    }
  }
}